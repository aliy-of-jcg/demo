...
export default function LandingPage() {
  ...
  const features = [
    {
      title: t('features.campaignManagement.title'),
      description: t('features.campaignManagement.description'),
      icon: Target,
      href: "/campaigns",
    ...
    {
      title: t('features.performanceDashboard.title'),
      description: t('features.performanceDashboard.description'),
      icon: BarChart,
      href: "/performance",
    ...
    {
      title: t('features.sessionJourneys.title'),
      description: t('features.sessionJourneys.description'),
      icon: PieChart,
    ...
    {
      title: t('features.channelPerformance.title'),
      description: t('features.channelPerformance.description'),
      icon: Globe,
    ...
    {
      title: t('features.campaignAnalysis.title'),
      description: t('features.campaignAnalysis.description'),
      icon: BarChart3,
    ...
    {
      title: t('features.environmentAnalysis.title'),
      description: t('features.environmentAnalysis.description'),
      icon: Activity,
    ...
    {
      title: t('features.timeAnalysis.title'),
      description: t('features.timeAnalysis.description'),
      icon: Clock,
      href: "/time-analysis",
    ...
    {
      title: t('features.returningAnalysis.title'),
      description: t('features.returningAnalysis.description'),
      icon: UserCheck,
    ...
    {
      title: t('features.utmList.title'),
      description: t('features.utmList.description'),
      icon: Tag,
      href: "/utm-tools",
              ...
              <Link key={index} href={feature.href}>
                <div className={`${feature.color} border-2 rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer h-full`}>
                  ...
                  <div className="flex items-center text-xs sm:text-sm font-medium text-blue-600">
                    {t('features.explore')} <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 ml-1" />
                  </div>
                </div>
              </Link>
            ))}
          ...
          {recentCampaigns.length > 0 && (
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t('recentCampaigns.title')}</h3>
                <Link href="/campaigns">
                  <div className="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center cursor-pointer">
                    {t('recentCampaigns.viewAll')} <ArrowRight className="w-4 h-4 ml-1" />
                  </div>
                </Link>
              </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl hover:bg-gray-100 transition-colors cursor-pointer border border-gray-200 gap-3">
                      ...
                      <div className="flex items-center gap-4 sm:gap-6 text-xs sm:text-sm">
                        <div className="text-center">
                          ...
                          <div className="text-xs text-gray-500">{t('recentCampaigns.clicks')}</div>
                        </div>
                        <div className="text-center">
                          <div className="font-bold text-purple-600 text-sm sm:text-base">{campaign.visitors || 0}</div>
                          <div className="text-xs text-gray-500">{t('recentCampaigns.visitors')}</div>
                        </div>
                      </div>
                    </div>
                  </Link>
